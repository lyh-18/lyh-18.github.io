...
nav: true
nav_order: 4
description: Research, curiosity, communication, and the long game.
---
...
<div class="journey-page">
  ...
  <section class="journey-themes" aria-labelledby="journey-themes-title">
    <div class="journey-heading">
      <span class="journey-kicker">不止一面 · MORE THAN ONE SIDE</span>
      <h2 id="journey-themes-title">人生的不同切面</h2>
      <p>没有标准路线，也没有孤立的高光。每一段经历，都在悄悄影响下一次选择。</p>
    </div>
    ...
    <div class="journey-grid">
      <article id="journey-growth" class="journey-card journey-card-wide card-blue journey-order-1">
        ...
        <div class="journey-duo">
          <figure><img src="{{ '/assets/img/journey/story-1.png' | relative_url }}" alt="刘翼豪参加国科大本科毕业典礼"><figcaption>国科大首届本科毕业</figcaption></figure>
          <figure><img src="{{ '/assets/img/journey/uwa-winthrop-hall.jpg' | relative_url }}" alt="西澳大利亚大学Winthrop Hall校园景观"><figcaption>西澳大学 Winthrop Hall · Perth（图片来源：UWA）</figcaption></figure>
        </div>
      </article>

      <article id="journey-campus-media" class="journey-card journey-card-horizontal card-coral journey-order-4">
        <figure><img src="{{ '/assets/img/journey/campus-media-illustration.png' | relative_url }}" alt="以科研思维运营校园媒体的主题插画"><figcaption>用数据理解读者，也用内容连接校园</figcaption></figure>
        <div class="journey-card-copy">
      ...
      <article id="journey-popular-science" class="journey-card journey-card-horizontal card-violet journey-order-3">
        <figure><img src="{{ '/assets/img/journey/spotlight-3.jpg' | relative_url }}" alt="刘翼豪进行科学传播分享"><figcaption>把专业知识讲清楚，也讲得让人愿意听</figcaption></figure>
        <div class="journey-card-copy">
          <div class="journey-labels"><span>科普创作</span><span>跨学科脑洞</span><span>一本正经地有趣</span></div>
          <h3>一本正经地，把科学讲得有趣</h3>
          <p>写科普最初只是<strong>“什么都想懂一点”</strong>的副产品。遇到陌生概念，我习惯先查资料、补基础，再想办法把它和熟悉的生活连接起来：用物理定律解释爱情，把《葫芦娃》的法宝拆成黑科技，也认真研究“双十一之后如何科学地吃土”。这些文章有些获得了远超预期的传播，其中<strong>《物理定律告诉你，天下有情人终将分手！》累计阅读超过千万并登上微博热搜</strong>。热闹之外，我更享受的是学习本身——为了讲清一个看似荒诞的问题，常常要先把多个学科的知识重新梳理一遍。科普于我，<strong>是表达，也是另一种学习方式</strong>。</p>
          <div class="journey-links"><a href="{{ '/popular-science/' | relative_url }}">浏览科普作品 →</a><a href="https://mp.weixin.qq.com/s/_dEUZbKgWQ5kPcf-LI8xjw" target="_blank" rel="noopener noreferrer">阅读代表作《物理定律告诉你，天下有情人终将分手！》 ↗</a></div>
        </div>
      </article>

      <article id="journey-campus-life" class="journey-card card-teal journey-order-6">
        <div class="journey-card-copy">
      ...
      <article id="journey-badminton" class="journey-card journey-card-wide card-yellow journey-card-horizontal journey-order-5">
        <div class="journey-card-copy">
          <div class="journey-labels"><span>热爱运动</span><span>耐心与节奏</span><span>科研之外</span></div>
          <h3>球场教会我的，是耐心与节奏</h3>
      ...
      <article id="journey-resilience" class="journey-card journey-card-horizontal card-violet journey-order-2">
        <figure><img src="{{ '/assets/img/journey/spotlight-4.jpg' | relative_url }}" alt="刘翼豪博士毕业"><figcaption>九年国科大 · 新的起点</figcaption></figure>
        <div class="journey-card-copy">
          <div class="journey-labels"><span>面对挫折</span><span>允许失败</span><span>继续向前</span></div>
          <h3>九年、四座城市与二十封拒信</h3>
          <p>九年的求学经历里，有毕业与远行，也有更多没有被照片记录的普通日子：想法被否定、实验跑不通、论文一次次被拒。<strong>二十多封拒信</strong>曾让人沮丧，却也慢慢教会我，不在情绪最糟糕的时候否定自己，也不把一次结果看成最终结论。科研的进展往往缓慢，能做的只是<strong>认真复盘、向同行请教，再把下一步做好</strong>。回头看，那些不顺利并不比所谓的“高光”更羞于展示，<strong>它们同样构成了成长</strong>。</p>
          <div class="journey-links"><a href="https://news.ucas.ac.cn/kyrw/736a70759bfb459d99680900d5f7b037.htm" target="_blank" rel="noopener noreferrer">完整成长故事 ↗</a></div>
        </div>
      </article>
